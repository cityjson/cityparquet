...
`benchmark/formats/READ_BENCHMARK.md` states what that costs and what it buys.
...
`benchmark/formats/scaling_*_results/` are **not** archived and were not affected: they

#!/usr/bin/env bash
# Tests for `benchmark/scripts/fetch_benchmark.sh` — the catalogue corpus fetcher.
#
...
FETCH="$BENCHMARK_DIR/scripts/fetch_benchmark.sh"
CATALOGUE="$BENCHMARK_DIR/formats/corpus_urls.txt"

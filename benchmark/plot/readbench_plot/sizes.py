...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "readbench prepared dir (e.g. benchmark/formats/data/readbench). The ratio is "
    ...
    parser.add_argument(
        ...
        type=Path,
        nargs="?",
        default=Path("benchmark/formats/read_results"),
        help="output directory for sizes.csv and plots/ (default: benchmark/formats/read_results)",
    )

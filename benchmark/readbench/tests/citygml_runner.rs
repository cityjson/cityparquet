...
/// A committed (in-repo) CityGML fixture under `crates/core/tests/data/`
/// — small REAL fragments carrying their own provenance/licence headers, the
/// same helper `crates/core/tests/citygml_real_data.rs` already uses.
///
...
/// file, `the retired catalogue corpus/catalogue_benchmark_urls.txt`.
#[test]

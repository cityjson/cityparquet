...
``bench/summary/`` and a caller elsewhere — the paper workspace, which wants the
...
def build_parser() -> argparse.ArgumentParser:
    ...
    common.add_argument(
        ...
        metavar="DIR",
        help="benchmark results to read (default: this repo's bench/)",
    )
    common.add_argument(
        "--out",
        type=Path,
        metavar="DIR",
        help="write all three outputs under DIR (default: bench/summary/)",
    )
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "left in bench/. Runs no benchmark of its own."
        ),
    )
